...
!function () {
  ...
  function n () {return 'undefined' != typeof CanvasRenderingContext2D}

  function a () {
    var t = !1, e = navigator.userAgent
    if (/android/i.test(e)) {
      t = !0
      var r = ('' + e).match(/android ([0-9]\.[0-9])/i)
  ...
  function s (t, e) {
    ...
    if (r > p.length) throw Error('Too long data')
    return r
  }

  function h (t) {
    var e = ('' + encodeURI(t)).replace(/\%[0-9a-fA-F]{2}/g, 'a')
    return e.length + (e.length != t ? 3 : 0)
  }

  t.prototype = {
    getLength: function (t) {return this.parsedData.length},
    write: function (t) {for (var e = 0, r = this.parsedData.length; r > e; e++) t.put(this.parsedData[e], 8)}
  }, e.prototype = {
    addData: function (e) {
      var r = new t(e)
    ...
    setupPositionProbePattern: function (t, e) {for (var r = -1; 7 >= r; r++) if (!(-1 >= t + r || this.moduleCount <= t + r)) for (var o = -1; 7 >= o; o++) -1 >= e + o || this.moduleCount <= e + o || (r >= 0 && 6 >= r && (0 == o || 6 == o) || o >= 0 && 6 >= o && (0 == r || 6 == r) || r >= 2 && 4 >= r && o >= 2 && 4 >= o ? this.modules[t + r][e + o] = !0 : this.modules[t + r][e + o] = !1)},
    ...
    setupPositionAdjustPattern: function () {
      for (var t = g.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++) for (var r = 0; r < t.length; r++) {
        var o = t[e], i = t[r]
        if (null == this.modules[o][i]) for (var n = -2; 2 >= n; n++) for (var a = -2; 2 >= a; a++) -2 == n || 2 == n || -2 == a || 2 == a || 0 == n && 0 == a ? this.modules[o + n][i + a] = !0 : this.modules[o + n][i + a] = !1
      }
    },
    ...
    for (var _ = Array(v), C = 0, f = 0; i > f; f++) for (var h = 0; h < e.length; h++) f < a[h].length && (_[C++] = a[h][f])
  ...
  for (var u = {MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8}, l = {
    ...
    getPatternPosition: function (t) {return g.PATTERN_POSITION_TABLE[t - 1]},
  ...
  r.prototype = {
    get: function (t) {return this.num[t]}, getLength: function () {return this.num.length}, multiply: function (t) {
      for (var e = Array(this.getLength() + t.getLength() - 1), o = 0; o < this.getLength(); o++) for (var i = 0; i < t.getLength(); i++) e[o + i] ^= d.gexp(d.glog(this.get(o)) + d.glog(t.get(i)))
      return new r(e, 0)
    }, mod: function (t) {
      if (this.getLength() - t.getLength() < 0) return this
      for (var e = d.glog(this.get(0)) - d.glog(t.get(0)), o = Array(this.getLength()), i = 0; i < this.getLength(); i++) o[i] = this.get(i)
  ...
  var p = [[17, 14, 11, 7], [32, 26, 20, 14], [53, 42, 32, 24], [78, 62, 46, 34], [106, 84, 60, 44], [134, 106, 74, 58], [154, 122, 86, 64], [192, 152, 108, 84], [230, 180, 130, 98], [271, 213, 151, 119], [321, 251, 177, 137], [367, 287, 203, 155], [425, 331, 241, 177], [458, 362, 258, 194], [520, 412, 292, 220], [586, 450, 322, 250], [644, 504, 364, 280], [718, 560, 394, 310], [792, 624, 442, 338], [858, 666, 482, 382], [929, 711, 509, 403], [1003, 779, 565, 439], [1091, 857, 611, 461], [1171, 911, 661, 511], [1273, 997, 715, 535], [1367, 1059, 751, 593], [1465, 1125, 805, 625], [1528, 1190, 868, 658], [1628, 1264, 908, 698], [1732, 1370, 982, 742], [1840, 1452, 1030, 790], [1952, 1538, 1112, 842], [2068, 1628, 1168, 898], [2188, 1722, 1228, 958], [2303, 1809, 1283, 983], [2431, 1911, 1351, 1051], [2563, 1989, 1423, 1093], [2699, 2099, 1499, 1139], [2809, 2213, 1579, 1219], [2953, 2331, 1663, 1273]],
    m = function () {
      ...
      }, t.prototype.clear = function () {for (; this._el.hasChildNodes();) this._el.removeChild(this._el.lastChild)}, t
      ...
      function e (t, e) {
        ...
        if (r._fFail = e, r._fSuccess = t, null === r._bSupportDataURI) {
          var o = document.createElement('img'), i = function () {r._bSupportDataURI = !1, r._fFail && r._fFail.call(r)},
            n = function () {r._bSupportDataURI = !0, r._fSuccess && r._fSuccess.call(r)}
      ...
      if (this._android && this._android <= 2.1) {
        ...
        CanvasRenderingContext2D.prototype.drawImage = function (t, e, i, n, a, s, h, u, l) {
          if ('nodeName' in t && /img/i.test(t.nodeName)) for (var f = arguments.length - 1; f >= 1; f--) arguments[f] = arguments[f] * r
          else void 0 === u && (arguments[1] *= r, arguments[2] *= r, arguments[3] *= r, arguments[4] *= r)
          o.apply(this, arguments)
        }
      }
      var i = function (t, e) {this._bIsPainted = !1, this._android = a(), this._htOption = e, this._elCanvas = document.createElement('canvas'), this._elCanvas.width = e.width, this._elCanvas.height = e.height, t.appendChild(this._elCanvas), this._el = t, this._oContext = this._elCanvas.getContext('2d'), this._bIsPainted = !1, this._elImage = document.createElement('img'), this._elImage.alt = 'Scan me!', this._elImage.style.display = 'none', this._el.appendChild(this._elImage), this._bSupportDataURI = null}
      return i.prototype.draw = function (t) {
        ...
        this._bIsPainted = !0
      }, i.prototype.makeImage = function () {this._bIsPainted && e.call(this, t)}, i.prototype.isPainted = function () {return this._bIsPainted}, i.prototype.clear = function () {this._oContext.clearRect(0, 0, this._elCanvas.width, this._elCanvas.height), this._bIsPainted = !1}, i.prototype.round = function (t) {return t ? Math.floor(1e3 * t) / 1e3 : t}, i
    }() : function () {
      var t = function (t, e) {this._el = t, this._htOption = e}
      return t.prototype.draw = function (t) {
      ...
      }, t.prototype.clear = function () {this._el.innerHTML = ''}, t
    }()
  QRCode = function (t, e) {
    if (this._htOption = {
        width: 256,
  ...
  }, QRCode.prototype.makeCode = function (t) {this._oQRCode = new e(s(t, this._htOption.correctLevel), this._htOption.correctLevel), this._oQRCode.addData(t), this._oQRCode.make(), this._el.title = t, this._oDrawing.draw(this._oQRCode), this.makeImage()}, QRCode.prototype.makeImage = function () {'function' == typeof this._oDrawing.makeImage && (!this._android || this._android >= 3) && this._oDrawing.makeImage()}, QRCode.prototype.clear = function () {this._oDrawing.clear()}, QRCode.CorrectLevel = l
